...
// `motion/react` (rebrand of framer-motion) renamed `DynamicAnimationOptions`
// to `AnimationOptions`. Alias kept for the original API surface.
type DynamicAnimationOptions = AnimationOptions;
...
const VerticalCutReveal = forwardRef<VerticalCutRevealRef, TextProps>(
  (
    ...
    // Unicode + emoji-safe character splitter
    ...
    const variants = {
      ...
      visible: (i: number) => ({
        ...
        transition: {
          ...transition,
          delay:
            ((transition?.delay as number) || 0) + getStaggerDelay(i),
        },
      }),
    };
